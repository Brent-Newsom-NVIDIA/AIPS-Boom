...
- **Retail ISV path:** [[NVIDIA-Retail-ISV-Ecosystem]] connects NIM and NeMo to retail ISVs such as [[Bloomreach]] for ecommerce search and [[LiveX-AI]] for customer-experience agents. [[PUMA-LiveX-AI-Store-Concierge]] provides a named retail proof point where [[LiveX-AI]] uses NVIDIA Nemotron, [[NeMo-Platform]], and NIM for an interactive in-store concierge.
...
- **Embodied assistant deployments:** [[LiveX-AI-GTC-Toy-Jensen-Holographic-Agent]] is a NVIDIA GTC deployment proof point using NIM microservices and [[Nemotron]] for a holographic assistant.
...
- [[PUMA-LiveX-AI-Store-Concierge]] - named customer proof point for LiveX AI using NVIDIA Nemotron, NeMo, and NIM in a retail AI concierge.
- [[LiveX-AI-GTC-Toy-Jensen-Holographic-Agent]] - NVIDIA GTC deployment proof point for NIM-backed embodied assistants.
