...
- [[ALDI]] - Retailer named by Instacart as offering Caper Carts powered by NVIDIA Jetson.
- [[AiFi]] - Retail ISV for autonomous shopping and spatial intelligence.
- [[Avathon]] - Retail ISV for visual store analytics, queue analytics, stock-out detection, and footfall analysis.
- [[BriefCam]] - Retail ISV for video search, alerting, visualization, loss prevention, and shopper-behavior analytics.
- [[Bloomreach]] - Retail ISV for ecommerce search, personalization, and omnichannel product discovery using NVIDIA NeMo/NIM.
- [[Bristol-Farms]] - Retailer named by Instacart as offering Caper Carts powered by NVIDIA Jetson.
- [[Caper-by-Instacart]] - Retail ISV for AI-powered smart carts and in-store shopper engagement on NVIDIA Jetson.
- [[Carrefour]] - Retailer named by NVIDIA as an AiFi autonomous retail deployment example.
- [[Centific]] - Retail ISV for Pitaya retail intelligence, computer vision, generative AI, inventory, safety, and loss prevention.
- [[Choice-Market]] - Denver retailer named by NVIDIA as an AiFi checkout-free shopping proof point.
- [[CoolerX]] - Retail ISV for smart cooler media, in-store merchandising, and retail media monetization.
- [[Everseen]] - Retail ISV for checkout loss prevention, inventory, queue management, and store vision AI.
- [[Fairway-Market]] - Retailer named by Instacart as offering Caper Carts powered by NVIDIA Jetson.
- [[Geisslers-Supermarket]] - Retailer named by Instacart as offering Caper Carts powered by NVIDIA Jetson.
- [[Graymatics]] - Retail ISV for VistaMart video analytics, asset protection, demographics, dwell time, and foot traffic.
- [[Hublot]] - LVMH brand named in SKAI Intelligence Omniverse/Isaac Sim retail content proof.
- [[Instacart]] - Grocery technology company behind Caper by Instacart and Caper Carts.
- [[Kroger]] - Named retail customer case study for Everseen checkout loss prevention on Lenovo/NVIDIA edge AI infrastructure.
- [[Lawson-China]] - Named retailer context for SandStar AI Store operations with NVIDIA-backed retail AI infrastructure.
- [[Lenovo]] - NVIDIA partner and edge AI infrastructure provider in the Kroger Everseen checkout-loss-prevention case study.
- [[LiveX-AI]] - Retail ISV for omnichannel customer-experience AI agents using NVIDIA NIM, NeMo, and Triton.
- [[LVMH]] - Luxury retail group named in SKAI Intelligence Omniverse/Isaac Sim digital twin retail content proof.
- [[Loop-Neighborhood]] - Retailer named by NVIDIA as an AiFi autonomous retail deployment example.
- [[Lyric]] - Retail ISV for GPU-accelerated supply-chain optimization, routing, and scenario planning with cuOpt.
- [[McKeevers-Market-and-Eatery]] - Retailer named by Instacart as offering Caper Carts powered by NVIDIA Jetson.
- [[Morrisons]] - U.K. retailer named by NVIDIA as an AiFi checkout-free store test.
- [[Penske-Entertainment]] - Event retail partner named by NVIDIA in an AiFi autonomous store deployment at the Indianapolis 500.
- [[Price-Chopper]] - Retailer named by Instacart as offering Caper Carts powered by NVIDIA Jetson.
- [[PUMA]] - Retail customer proof point for LiveX AI in-store concierge using NVIDIA Nemotron, NeMo, and NIM.
- [[SandStar]] - Retail ISV for AI vending, smart stores, unattended shops, Jetson, and DeepStream.
- [[Schnucks]] - Retailer named by Instacart as scaling Caper Carts powered by NVIDIA Jetson.
- [[SKAI-Intelligence]] - Retail and CPG ISV for synthetic data, digital twins, 3D product assets, Omniverse, and Isaac Sim.
- [[ShopRite]] - Retailer named by Instacart as offering Caper Carts powered by NVIDIA Jetson.
- [[The-Fresh-Grocer]] - Retailer named by Instacart as offering Caper Carts powered by NVIDIA Jetson.
- [[Verizon-Business]] - Partner named by NVIDIA in an AiFi autonomous store deployment at the Indianapolis 500.
- [[Zabka]] - Polish convenience retailer named by NVIDIA as an AiFi autonomous store deployment example.
...
- [[NVIDIA-Enterprise-RA-Partner-Endorsed-Designs]] - Partner-endorsed OEM design matrix for Cisco, Dell, HPE, Lenovo, and Supermicro Enterprise RA implementations
...
### Retail and Partner Implementation
- [[NVIDIA-Retail-ISV-Ecosystem]] - Retail ISV recommendation hub mapping workloads to NVIDIA stack choices and partner implementers
- [[NVIDIA-Partner-Network]] - NVIDIA partner ecosystem program context for ISVs, solution providers, and implementation partners
- [[AiFi-Metropolis-Autonomous-Retail-Deployments]] - Named-deployment proof page for AiFi autonomous retail using NVIDIA Metropolis and NVIDIA GPU-powered edge AI
- [[Caper-Jetson-Smart-Cart-Retail-Deployments]] - Named-retailer proof page for Caper Carts powered by NVIDIA Jetson
- [[Kroger-Everseen-Checkout-Loss-Prevention]] - Named-customer case study for Everseen Visual AI, Lenovo Edge AI servers, and NVIDIA T4 GPUs in self-checkout loss prevention
- [[Centific-NVIDIA-Edge-Retail-Loss-Prevention]] - Anonymized home-improvement-retailer deployment proof for Centific computer vision and NVIDIA edge computing
- [[BriefCam-NVIDIA-Metropolis-Video-Analytics]] - NVIDIA Metropolis/GPU proof for BriefCam video analytics and organized retail crime workflows
- [[Avathon-NVIDIA-VSS-Video-Intelligence]] - NVIDIA VSS integration proof for Avathon video search, summarization, and incident analysis
- [[CoolerX-Kroger-NVIDIA-In-Store-Retail-Media]] - Named Kroger proof point for CoolerX in-store retail media with NVIDIA collaboration evidence
- [[Lawson-China-SandStar-NVIDIA-Store-Operations]] - Named Lawson China proof point for SandStar AI Store operations and NVIDIA-backed retail AI
- [[PUMA-LiveX-AI-Store-Concierge]] - Named retail customer proof point for LiveX AI using NVIDIA Nemotron, NeMo, and NIM
- [[LiveX-AI-GTC-Toy-Jensen-Holographic-Agent]] - NVIDIA GTC deployment proof point for LiveX AI using RTX GPUs, NVIDIA NIM, and Nemotron
- [[SKAI-LVMH-Omniverse-Digital-Twin-Retail-Content]] - Named LVMH/Hublot proof point for SKAI Intelligence, NVIDIA Omniverse, and Isaac Sim
...
- [[AiFi-Metropolis-Autonomous-Retail-Deployments]] - Named-deployment proof page for AiFi autonomous retail using NVIDIA Metropolis and NVIDIA GPU-powered edge AI
- [[Caper-Jetson-Smart-Cart-Retail-Deployments]] - Named-retailer proof page for Caper Carts powered by NVIDIA Jetson
- [[Kroger-Everseen-Checkout-Loss-Prevention]] - Named-customer self-checkout loss-prevention case study using Everseen Visual AI on Lenovo/NVIDIA edge infrastructure
- [[Centific-NVIDIA-Edge-Retail-Loss-Prevention]] - Anonymized home-improvement-retailer deployment proof for Centific loss prevention with NVIDIA edge computing
- [[BriefCam-NVIDIA-Metropolis-Video-Analytics]] - NVIDIA Metropolis/GPU proof for BriefCam video analytics and organized retail crime workflows
- [[Avathon-NVIDIA-VSS-Video-Intelligence]] - NVIDIA VSS integration proof for Avathon video search, summarization, and incident analysis
- [[CoolerX-Kroger-NVIDIA-In-Store-Retail-Media]] - Named Kroger proof point for CoolerX in-store retail media and smart screens
- [[Lawson-China-SandStar-NVIDIA-Store-Operations]] - Named Lawson China proof point for SandStar AI Store operations
- [[PUMA-LiveX-AI-Store-Concierge]] - Named retail customer proof point for LiveX AI using NVIDIA Nemotron, NeMo, and NIM
- [[LiveX-AI-GTC-Toy-Jensen-Holographic-Agent]] - NVIDIA GTC deployment proof point for LiveX AI using RTX GPUs, NVIDIA NIM, and Nemotron
- [[SKAI-LVMH-Omniverse-Digital-Twin-Retail-Content]] - Named LVMH/Hublot proof point for SKAI Intelligence, NVIDIA Omniverse, and Isaac Sim
