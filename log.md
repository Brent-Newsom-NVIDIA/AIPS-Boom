...
## 2026-05-17 - Local ingest: Batch 3 retail ISV NVIDIA workload proof for Centific, CoolerX, SandStar, BriefCam, and Avathon

**Source URLs:** https://www.centific.com/case-studies/leading-home-improvement-retailer, https://www.nvidia.com/en-us/on-demand/session/gtc24-s62627/, https://www.einpresswire.com/article/680609070/cooler-screens-launches-coolerx-using-ai-to-power-digital-in-store-retail-experiences-and-unlock-consumer-intent, https://www.nvidia.com/gtc/session-catalog/sessions/gtc26-s81675/, https://en.sandstar.com/ai-store.html, https://www.briefcam.com/company/news/nvidia-and-loss-prevention-retail-council-introduce-ai-solution-to-address-organized-retail-crime/, https://www.briefcam.com/company/press-releases/briefcam-nvidia-gpus/, https://avathon.com/press-release/avathon-advances-industrial-video-ai-with-nvidia-vss/

**Pages created (6 total):**

- `content/wiki/Centific-NVIDIA-Edge-Retail-Loss-Prevention.md` - anonymized home-improvement-retailer deployment proof for Centific computer vision and NVIDIA edge computing at checkout lanes
- `content/wiki/CoolerX-Kroger-NVIDIA-In-Store-Retail-Media.md` - named Kroger proof point for CoolerX in-store retail media with NVIDIA collaboration evidence
- `content/wiki/Lawson-China-SandStar-NVIDIA-Store-Operations.md` - named Lawson China proof point for SandStar AI Store operations and NVIDIA-backed retail AI infrastructure
- `content/wiki/Lawson-China.md` - organization page for Lawson China as the named retailer context in the SandStar proof point
- `content/wiki/BriefCam-NVIDIA-Metropolis-Video-Analytics.md` - NVIDIA Metropolis/GPU proof for BriefCam video analytics, organized retail crime workflows, and non-retail named deployment context
- `content/wiki/Avathon-NVIDIA-VSS-Video-Intelligence.md` - NVIDIA VSS integration proof for Avathon video search, summarization, and incident analysis

**Pages updated:**

- `content/wiki/Centific.md` - added anonymized NVIDIA edge loss-prevention deployment proof
- `content/wiki/CoolerX.md` - added Kroger/NVIDIA in-store retail media proof
- `content/wiki/Kroger.md` - added CoolerX as supporting retail-media context while preserving Everseen as Kroger's strongest loss-prevention proof
- `content/wiki/SandStar.md` - added Lawson China AI Store proof and NVIDIA Cloud Partner context
- `content/wiki/BriefCam.md` - added NVIDIA Metropolis/GPU proof and organized retail crime integration evidence
- `content/wiki/Avathon.md` - added NVIDIA VSS integration proof
- `content/wiki/NVIDIA-Retail-ISV-Ecosystem.md` - added Batch 3 proof pages to ISV recommendation logic
- `content/wiki/NVIDIA-Metropolis.md` - added Batch 3 retail video analytics and store-operations proof links
- `content/wiki/NVIDIA-DeepStream.md` - added Batch 3 retail ISV proof links
- `content/wiki/NVIDIA-Video-Search-and-Summarization-Blueprint.md` - added Avathon VSS integration proof
- `content/index.md` - added new organization and project pages; updated total page count
- `content/retail-isv-nvidia-case-study-scratch.md` - recorded Batch 3 accepted/deferred research status

**Graymatics status:** Researched in this batch. No accepted public named customer or named deployment explicitly tied to NVIDIA technology was found, so no new Graymatics case page was created.

**GitHub push:** No. Changes are local only pending user instruction.

---

## 2026-05-17 - Local ingest: Batch 2 retail ISV named deployments for LiveX AI and SKAI Intelligence

**Source URLs:** https://www.retailtouchpoints.com/news/puma-to-debut-ai-powered-interactive-in-store-concierge/618099/, https://blogs.nvidia.com/blog/gtc-2026-news/, https://www.linkedin.com/posts/maomorgan_excited-to-return-speak-at-nvidia-gtc-2026-activity-7435555481466626048-9BwQ, https://www.edaily.co.kr/News/Read?mediaCodeNo=257&newsId=02938886645384632, https://www.prnewswire.com/news-releases/skai-intelligence-unveils-the-future-of-retail-imaging-at-vivatech-2025-302483041.html

**Pages created (6 total):**

- `content/wiki/PUMA-LiveX-AI-Store-Concierge.md` - named retail customer proof point for PUMA using LiveX AI with NVIDIA Nemotron, NeMo, and NIM for an in-store AI concierge
- `content/wiki/PUMA.md` - organization page for PUMA as the named LiveX AI retail customer
- `content/wiki/LiveX-AI-GTC-Toy-Jensen-Holographic-Agent.md` - NVIDIA GTC deployment proof point for LiveX AI using RTX GPUs, NVIDIA NIM microservices, and Nemotron
- `content/wiki/SKAI-LVMH-Omniverse-Digital-Twin-Retail-Content.md` - named LVMH/Hublot proof point for SKAI Intelligence with NVIDIA Omniverse and Isaac Sim retail content workflows
- `content/wiki/LVMH.md` - organization page for LVMH as the named SKAI customer context
- `content/wiki/Hublot.md` - organization page for the LVMH brand named in the SKAI GTC material

**Pages updated:**

- `content/wiki/LiveX-AI.md` - added PUMA named retail customer proof and GTC Toy Jensen deployment proof
- `content/wiki/SKAI-Intelligence.md` - added LVMH/Hublot named proof point for Omniverse and Isaac Sim retail content workflows
- `content/wiki/NVIDIA-Retail-ISV-Ecosystem.md` - added LiveX AI and SKAI named proof points to recommendation logic
- `content/wiki/NVIDIA-NIM.md` - added LiveX/PUMA and LiveX/GTC proof points for retail and embodied agents
- `content/wiki/Nemotron.md` - added LiveX/PUMA and LiveX/GTC proof points for Nemotron-backed agents
- `content/wiki/NVIDIA-Omniverse.md` - added SKAI/LVMH named proof point for retail digital twin workflows
- `content/wiki/NVIDIA-Isaac-Sim.md` - added SKAI/LVMH retail content workflow context
- `content/index.md` - added new organizations and project pages; updated total page count
- `content/retail-isv-nvidia-case-study-scratch.md` - recorded Batch 2 accepted/deferred research status

**Lyric status:** Researched in this batch. Public sources confirm the Lyric plus NVIDIA cuOpt workload, but no accepted named Lyric customer explicitly tied to NVIDIA cuOpt was found. No named-customer case page was created.

**GitHub push:** No. Changes are local only pending user instruction.

---

## 2026-05-17 - Local ingest: Batch 1 retail ISV named deployments for AiFi and Caper

**Source URLs:** https://blogs.nvidia.com/blog/ai-fi-retail/, https://www.instacart.com/company/updates/transforming-in-store-shopping-caper-carts-ai-magic-powered-by-nvidia-jetson/, https://www.bloomreach.com/en/news/2024/bloomreach-revolutionizes-ecommerce-search-powered-by-nvidia-nem/

**Pages created (19 total):**

- `content/wiki/AiFi-Metropolis-Autonomous-Retail-Deployments.md` - named-deployment proof page for AiFi autonomous retail using NVIDIA Metropolis and NVIDIA GPU-powered edge AI
- `content/wiki/Choice-Market.md` - named retailer proof point for AiFi checkout-free shopping
- `content/wiki/Zabka.md` - named retailer proof point for AiFi autonomous stores in Poland
- `content/wiki/Penske-Entertainment.md` - named event retail deployment partner for AiFi at the Indianapolis 500
- `content/wiki/Verizon-Business.md` - named event retail deployment partner for AiFi at the Indianapolis 500
- `content/wiki/Loop-Neighborhood.md` - named retailer proof point for AiFi autonomous retail in California
- `content/wiki/Carrefour.md` - named retailer proof point for AiFi Flash LabStore autonomous retail
- `content/wiki/Morrisons.md` - named retailer proof point for AiFi checkout-free store testing in the U.K.
- `content/wiki/Caper-Jetson-Smart-Cart-Retail-Deployments.md` - named-retailer proof page for Caper Carts powered by NVIDIA Jetson
- `content/wiki/Instacart.md` - parent organization and source context for Caper by Instacart
- `content/wiki/Bristol-Farms.md` - named retailer offering Caper Carts powered by NVIDIA Jetson
- `content/wiki/Fairway-Market.md` - named retailer offering Caper Carts powered by NVIDIA Jetson
- `content/wiki/The-Fresh-Grocer.md` - named retailer offering Caper Carts powered by NVIDIA Jetson
- `content/wiki/Geisslers-Supermarket.md` - named retailer offering Caper Carts powered by NVIDIA Jetson
- `content/wiki/McKeevers-Market-and-Eatery.md` - named retailer offering Caper Carts powered by NVIDIA Jetson
- `content/wiki/Price-Chopper.md` - named retailer offering Caper Carts powered by NVIDIA Jetson
- `content/wiki/Schnucks.md` - named retailer scaling Caper Carts powered by NVIDIA Jetson
- `content/wiki/ShopRite.md` - named retailer offering Caper Carts powered by NVIDIA Jetson
- `content/wiki/ALDI.md` - named retailer offering Caper Carts powered by NVIDIA Jetson

**Pages updated:**

- `content/wiki/AiFi.md` - added NVIDIA-authored named-deployment examples and linked the AiFi Metropolis case page
- `content/wiki/Caper-by-Instacart.md` - added named-retailer Caper Cart examples and linked the Jetson smart-cart case page
- `content/wiki/Kroger.md` - added supporting Caper Cart evidence while preserving the Everseen/NVIDIA T4 case as Kroger's strongest detailed proof point
- `content/wiki/NVIDIA-Retail-ISV-Ecosystem.md` - added AiFi and Caper named-deployment proof points to recommendation logic
- `content/wiki/NVIDIA-Metropolis.md` - added AiFi autonomous retail proof point
- `content/wiki/NVIDIA-Jetson-Platform.md` - added Caper smart-cart proof point
- `content/index.md` - added new organizations and project pages; updated total page count
- `content/retail-isv-nvidia-case-study-scratch.md` - recorded Batch 1 accepted/rejected research status

**Bloomreach status:** Researched in this batch. Public sources found a strong NVIDIA NeMo/NIM integration story, but no accepted named-customer deployment explicitly tied to NVIDIA technology yet. No named-customer case page was created.

**GitHub push:** No. Changes are local only pending user instruction.

---

## 2026-05-17 - Local ingest: Kroger named-customer case study for Everseen checkout loss prevention

**Source URL:** https://www.lenovo.com/content/dam/lenovo/iso/customer-references-coe/global/en/case-studies/kroger/case-study-kroger.pdf

**Pages created (3 total):**

- `content/wiki/Kroger-Everseen-Checkout-Loss-Prevention.md` - named-customer case study for Kroger using Everseen Visual AI on Lenovo Edge AI servers with NVIDIA T4 Tensor Core GPUs for self-checkout loss prevention
- `content/wiki/Kroger.md` - organization page for Kroger as the named retail customer
- `content/wiki/Lenovo.md` - organization page for Lenovo as the edge AI infrastructure provider and Enterprise RA partner

**Pages updated:**

- `content/wiki/Everseen.md` - added Kroger named-customer proof point and linked case study
- `content/wiki/NVIDIA-Retail-ISV-Ecosystem.md` - added Kroger proof point to the Everseen recommendation row and checkout-loss-prevention recommendation map
- `content/index.md` - added Kroger, Lenovo, and the case study; updated total page count

**GitHub push:** No. Changes are local only pending user instruction.

---

## 2026-05-17 - Local ingest: Enterprise RA partner endorsed designs and retail ISV ecosystem

**Source URLs:** https://docs.nvidia.com/enterprise-reference-architectures/index.html, https://www.cisco.com/c/en/us/products/collateral/data-center-networking/nexus-hyperfabric/hyperfabric-ai-era-ds.html, https://www.cisco.com/c/en/us/products/collateral/switches/nexus-9000-series-switches/nexus-9000-ai-era-ds.html, https://www.cisco.com/c/en/us/products/collateral/servers-unified-computing/ai-pod-ucs-c885a-servers-nexus-9364e--sg2-switches.html, https://www.delltechnologies.com/asset/en-us/solutions/infrastructure-solutions/briefs-summaries/nvidia-2-8-5-200-era-configuration-endorsed-for-the-dell-ai-factory-with-nvidia-brief.pdf, https://www.delltechnologies.com/asset/en-us/solutions/infrastructure-solutions/briefs-summaries/nvidia-2-8-9-400-configuration-era-endorsed-for-the-dell-ai-factory-with-nvidia-brief.pdf, https://www.delltechnologies.com/asset/en-us/products/storage/technical-support/dell-ai-factory-with-nvidia-rtx-pro-6000-on-dell-poweredge-servers-datasheet.pdf, https://www.hpe.com/psnow/doc/a00157780enw, https://lenovopress.lenovo.com/lp2286-lenovo-hybrid-ai-289-platform-guide, https://www.supermicro.com/datasheet/Datasheet_Supermicro_NVIDIA_AI_Factories_HGX.pdf, https://www.supermicro.com/datasheet/Datasheet_Supermicro_NVIDIA_AI_Factories_RTX_PRO_6000.pdf, https://www.supermicro.com/datasheet/Datasheet_Supermicro_NVIDIA_AI_Factories_HGX_B300.pdf, https://www.nvidia.com/en-us/industries/retail/partners/

**Pages created (16 total):**

- `content/wiki/NVIDIA-Enterprise-RA-Partner-Endorsed-Designs.md` - Partner endorsed design matrix for Cisco, Dell, Dell Federal, HPE, Lenovo, and Supermicro Enterprise RA implementations, including endorsement criteria, solution notes, and recommendation logic
- `content/wiki/NVIDIA-Retail-ISV-Ecosystem.md` - Retail ISV recommendation hub mapping workloads to NVIDIA stack choices and partner implementers
- `content/wiki/NVIDIA-Partner-Network.md` - Partner-program context for NPN and ecosystem-based implementation recommendations
- `content/wiki/AiFi.md` - Retail ISV page for autonomous shopping and spatial intelligence
- `content/wiki/Avathon.md` - Retail ISV page for visual store analytics, queues, stock-outs, and footfall
- `content/wiki/BriefCam.md` - Retail ISV page for video search, alerting, visualization, and loss-prevention analytics
- `content/wiki/Bloomreach.md` - Retail ISV page for ecommerce search and personalization using NeMo/NIM
- `content/wiki/Caper-by-Instacart.md` - Retail ISV page for AI-powered smart carts on Jetson
- `content/wiki/Centific.md` - Retail ISV page for Pitaya retail intelligence, computer vision, generative AI, inventory, and loss prevention
- `content/wiki/CoolerX.md` - Retail ISV page for smart cooler media and retail media monetization
- `content/wiki/Everseen.md` - Retail ISV page for checkout loss prevention, inventory, queue management, and store vision AI
- `content/wiki/Graymatics.md` - Retail ISV page for VistaMart video analytics and store analytics
- `content/wiki/LiveX-AI.md` - Retail ISV page for customer-experience AI agents using NIM, NeMo, and Triton
- `content/wiki/Lyric.md` - Retail ISV page for supply-chain optimization, routing, scenario planning, and cuOpt
- `content/wiki/SandStar.md` - Retail ISV page for AI vending, smart stores, unattended shops, Jetson, and DeepStream
- `content/wiki/SKAI-Intelligence.md` - Retail and CPG ISV page for synthetic data, digital twins, 3D product assets, Omniverse, and Isaac Sim

**Pages updated:**

- `content/index.md` - added new organization entries, Enterprise RA partner design entry, retail partner implementation section, and updated total page count/date
- `content/wiki/NVIDIA-Enterprise-Reference-Architectures.md` - linked the partner endorsed design catalog and refreshed program summary
- `content/wiki/NVIDIA-Enterprise-AI-Factory.md` - linked partner endorsed designs as the route from reference design to OEM AI factory implementation
- `content/wiki/NVIDIA-RTX-PRO-AI-Factory.md` - added current partner-endorsed 2-8-5-200 implementations
- `content/wiki/NVIDIA-HGX-AI-Factory.md` - added current partner-endorsed HGX implementations
- `content/wiki/NVIDIA-NVL72-AI-Factory.md` - connected NVL72 RA to the partner design catalog
- `content/wiki/NVIDIA-Metropolis.md` - added retail ISV ecosystem links for intelligent-store recommendations
- `content/wiki/NVIDIA-DeepStream.md` - added retail ISV path for DeepStream/Metropolis workloads
- `content/wiki/NVIDIA-NIM.md` - added retail ISV path for Bloomreach and LiveX AI NIM/NeMo workloads
- `content/wiki/cuOpt.md` - added Lyric retail supply-chain optimization path
- `content/wiki/NVIDIA-Omniverse.md` - added SKAI Intelligence retail/CPG digital twin and 3D asset path

**GitHub push:** No. Changes are local only per user request.
...
- `content/wiki/cuBLASLt.md`
- `content/wiki/cuBLASXt.md`

**Pages updated:**

- `content/wiki/cuBLAS.md` - converted cuBLASLt/cuBLASXt mentions into canonical wikilinks and added connections.
- `content/wiki/NVIDIA-CUDA.md` - connected cuBLASLt/cuBLASXt into the CUDA library graph.
- `content/wiki/JAX.md` - linked cuBLASLt from the XLA/GEMM connection.
